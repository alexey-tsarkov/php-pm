        ...
        $treeBuilder->getRootNode()
            ...
            ->children()
                ...
                ->integerNode('max-execution-time')
                    ...
                    ->min(-1)
                    ->defaultValue($defaults['max-execution-time'])
                    ->beforeNormalization()
                        ->ifString()
                        ->then($this->castTo('integer'))
                    ->end()
                ...
                ->integerNode('memory-limit')
                    ...
                    ->min(-1)
                    ->defaultValue($defaults['memory-limit'])
                    ->beforeNormalization()
                        ->ifString()
                        ->then($this->castTo('integer'))
                    ->end()
                ...
                ->booleanNode('populate-server-var')
                    ...
                    ->defaultValue($defaults['populate-server-var'])
                    ->beforeNormalization()
                        ->ifString()
                        ->then($this->castTo('boolean'))
                    ->end()
                ...
                ->scalarNode('bootstrap')
                    ...
                    ->defaultValue($defaults['bootstrap'])
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('cgi-path')
                ...
                ->integerNode('reload-timeout')
                    ...
                    ->min(-1)
                    ->defaultValue($defaults['reload-timeout'])
                    ->beforeNormalization()
                        ->ifString()
                        ->then($this->castTo('integer'))
                    ->end()
